...
public class AdminController {
    ...
    public ResponseEntity handleUserReport(@RequestBody ReportDTO reportDTO) {

       // userReportsService.handleUserReport(ReportsDTOMapper.mapInputReportToUserReport(re));

        return null;
    }

    @PutMapping("/reports/restaurants/{id}")
    public ResponseEntity handleRestaurantReport(@RequestBody ReportDTO reportDTO) {
